...
%\photo[][]{img.jpg}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
\quote{some quote}
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Lettre de motivation}{Faculté des Sciences\\{Place Eugène Bataillon} {34090} {}\\Montpellier}
\date{\today}
