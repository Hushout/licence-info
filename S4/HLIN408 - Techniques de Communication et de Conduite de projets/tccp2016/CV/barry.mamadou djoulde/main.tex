...
% personal data
\name{BARRY}{MAMADOU DJOULDE}                              % optional, remove / comment the line if not wanted
\address{205 Rue Croix de Las Cazes}{34000}{Montpellier}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty                   % optional, remove / comment the line if not wanted
\phone[fixed]{+33753223938}                    % optional, remove / comment the line if not wanted                      % optional, remove / comment the line if not wanted
\email{barrydjoulde15@gmail.com}                               % optional, remove / comment the line if not wante                         % optional, remove / comment the line if not wanted                % optional, remove / comment the line if not wanted
