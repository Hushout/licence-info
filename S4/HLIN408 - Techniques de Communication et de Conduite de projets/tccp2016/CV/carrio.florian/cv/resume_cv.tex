...
\name{Florian}{Carrio}
\address{Residence Savary, 348 avenue Maurice et Katia Krafft, 34090, Montpellier}
\mobile{(+33) 0658263348}

\email{deymos66@gmail.com}
\github{Necosyx}
\skype{Ayako.ishima}
%\stackoverflow{SOid}{SOname}
\twitter{FollowSow}

\position{Informaticien} % Your expertise/fields
\quote{``Ceux qui savent parle pas, ceux qui parlent savent pas"} % A quote or statement

\makecvfooter{\today}{Florian Carrio ~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
